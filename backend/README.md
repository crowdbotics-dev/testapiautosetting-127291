...
## Project Structure
    ...
    ├── testapiautosetting_127291  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127291`
...
2. Clone this repo and `cd testapiautosetting_127291`
